	...
	return {
		...
		start:function(){
			...
			if(!lib.config.new_tutorial){
				...
				var step1=function(){
					ui.create.dialog('欢迎来到角完杀，是否进入新手向导？');
				...
				var step5=function(){
					clear();
					ui.create.dialog('如果还有其它问题，欢迎加入角完杀官方QQ群进行交流，角完QQ1477675561');
		...
		help:{
			...
			'<li>制作团队<br>游戏出品：角完<br>游戏设计：角完<br>游戏开发：角完<br>程序化：角完杀<br>鸣谢：游卡</ul></ul>',
		}
	};
});
